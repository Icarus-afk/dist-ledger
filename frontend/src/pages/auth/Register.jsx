  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/register/${formData.entityType}`,
        {
          method: "POST",
          headers: {
      ...
      if (data.success) {
        // FIXED: Correctly extract values from the entity property
        setRegistrationResult({
          id: data.entity.id,
          apiKey: data.entity.apiKey,
          entityType: formData.entityType,
          name: data.entity.name || formData.name,
        });
      } else {
    ...
    <Card className="w-full">
      ...
      {registrationResult ? (
        <div className="space-y-6">
          <Alert
            ...
            message="Your account has been created. Please save your Key.  you'll need these to log in."
          />
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <div className="flex items-center mt-1">
                  ...
                  <button
                    onClick={() =>
                      handleCopyToClipboard(registrationResult.apiKey)
                    }
      ...
      <div className="mt-4 pt-4 border-t border-neutral-200 text-center">
        <Link
          ...
          className="text-sm text-highlight-600 hover:text-highlight-700"
        >
          Verify a product
        </Link>
      </div>
